...
public record ServicePaymentDTO(
        ...
        @NotNull(message = "Service supplier ID cannot be null", groups = OnCreate.class)
        @Positive(message = "Service supplier ID must be positive", groups = {OnCreate.class, OnUpdate.class})
        ...
        @Schema(description = "Unique identifier of the building where the service was provided. " +
                ...
                example = "12",
                requiredMode = Schema.RequiredMode.REQUIRED)
        @NotNull(message = "Building ID cannot be null", groups = OnCreate.class)
        @Positive(message = "Building ID must be positive", groups = {OnCreate.class, OnUpdate.class})
        Long buildingId,
        ...
        @Schema(description = "Type of service paid. Valid values: " +
                ...
                requiredMode = Schema.RequiredMode.REQUIRED)
        @NotNull(message = "Service type cannot be null", groups = OnCreate.class)
        ...
        @Size(max = 100, message = "Reference number must not exceed 100 characters", groups = {OnCreate.class, OnUpdate.class})
